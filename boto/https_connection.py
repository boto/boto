...
# This file is derived from http://goo.gl/JUPqK
...
class CertValidatingHTTPSConnection(compat.httplib.HTTPConnection):
    ...
    def __init__(self, host, port=None, key_file=None, cert_file=None,
        ...
        Args:
            ...
            strict: When true, causes BadStatusLine to be raised
                    if the status line can't be parsed as a valid
                    HTTP/1.0 or 1.1 status line.
        """
        compat.httplib.HTTPConnection.__init__(self, host, port,
                                               strict, **kwargs)
    ...
    def connect(self):
        ...
        if not ValidateCertificateHostname(cert, hostname):
            msg = 'remote hostname "%s" does not match certificate' % hostname
            raise InvalidCertificateException(hostname, cert, msg)
